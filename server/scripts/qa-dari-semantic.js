...
function buildPrompt(en, tgt, lang) {
    return [
        ...
        ``,
        // ⚠ 1차 실행(2026-08-29)에서 나온 오탐 3유형을 명시적으로 막는다 — ko 표본 5건 중 3건이 오탐이었다.
        `HARD RULES — violating these makes your answer wrong:`,
        `  1. If your TARGET quote is identical to your SOURCE quote, it is NOT an issue. Never report it.`,
        `     (A proper noun deliberately left untranslated is correct behaviour, not a mistake.)`,
        `  2. Judge ONLY whether TARGET faithfully renders SOURCE. You have no knowledge of today's date and`,
        `     no authority over real-world facts. Never report that a claim in SOURCE is outdated, wrong, or`,
        `     that "X years later" no longer holds — that is about SOURCE, not about the translation.`,
        `  3. If a title, name or term is unfamiliar to you, ASSUME IT IS CORRECT. Do not report it as`,
        `     "not a known title" or "seems invented" — these are real Korean films, shows and people.`,
        `  4. If your own explanation would contain "which is accurate", "this is correct" or similar,`,
        `     do not report the item at all.`,
        ``,
