...
## 탭 구성 (2026-03-26 기준)
- TAB_ORDER: `['home', 'scene', 'translation', 'vocab', 'listening', 'library', 'video', 'stats']`
- **home**: 주간 목표 별, 오늘 진행률 게이지, 학습 메뉴 6폴더(단어학습/대화연습/사전/듣기연습/동영상/단어장) CTA, 주간/월간 통계
- **listening**: 에세이/대화 지문 생성 + 핵심 단어 5개 + TTS 듣기 + 발음연습 (2026-03-26 신규)
